...
namespace ExpenseSharingApp
{
    ...
    class Program
    {
        ...
        {
            // ---- Create users ----
            var anshika = app.CreateUser("Anshika", "anshika@example.com");
            ...
            app.AddMember(flat.GroupId, anshika.UserId);
            ...
            // ---- Add expenses ----
            app.AddExpense(flat.GroupId, anshika.UserId, "Rent",        3000m, DateTime.Today.AddDays(-5));
